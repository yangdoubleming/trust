<template>
    <section>
        <div class="header">
            ...
            <div class="arrow_02">
                <div class="word wordColor"><span class="num">3.   </span>申请信息</div>
            </div>
            <div class="arrow_03">
        ...
        <div class="wscn-http404-container">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
                ...
                <el-form-item label="贷款综合利率" prop="loanRate">
                    <span>{{loanRate}}</span>
                </el-form-item>
                ...
                <el-form-item label="" prop="type">
                    ...
                    <span style="color:#606266">我已阅读并同意<label style="color:#409EFF;cursor:pointer;"><span @click="showPdf">《豆沙包服务协议》</span></label></span>
                </el-form-item>
                <el-form-item>
